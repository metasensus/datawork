...
def processhwdata(datatype):
    ...
    sqlstmt='select distinct YYMMDD from vw_eventlog_current_ecc where yymmdd like \'14%\' order by yymmdd';
    constr='ods/ods@callhomeods.3pardata.com:1521/callhomeods';
    oraconn=oracon.openconnect(constr);   
    ...
    for yrec in yyres:
        ...
        #    time.sleep(1200);
        #    numdays=0;
        numproc = commands.getoutput("ps -ef | grep [p]rocess_eventlog_gaps |wc -l");
