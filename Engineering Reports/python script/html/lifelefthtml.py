...
def read_data(json_file,json_location,html_template,html_name,json_url,title):
	...
	datstr+='\n\t\t\t left: 59%;'
        ...
        datstr+='\n\t\t\t\t\t.offset([-10, 0])'
        datstr+='\n\t\t\t\t\t.html(function(d) {'
        datstr+="""\n\t\t\t\t\treturn "<strong>Lifeleft:</strong> <span style='color:red'>" + d[z1] +"</span><br><strong>Percent System:</strong> <span style='color:red'>"+d[y1]+"%"+ "</span>";})"""
	...
	datstr+='\n\t\t\t\t\t.text(y1);'
        ...
        datstr+='\n\t\t\t\t\t.enter().append("rect")'
        datstr+='\n\t\t\t\t\t.attr("class", "bar")'
        datstr+='\n\t\t\t\t\t.style("fill", function(d) { return d[c1];})'
	...
	datstr+='\n\t\t\t\t{'
	datstr+='\n\t\t\t\t\tvar tblRow = "<tr>" + "<td>" + data.data[i][x1] + "</td>" +"<td>" + data.data[i][y1] + "</td>" + "<td>"+data.data[i][z1]+"</td>"+ "</tr>"'
	...
	datstr+='\n\t\t\t\t\t\t<a class="navbar-brand" href="#">SSD Lifeleft Analysis</a>'
	datstr+='\n\t\t\t\t\t\t</div>'
	...
	datstr+='\n\t\t\t\t\t</div>'
       ...
       #left side menu  
        ...
        datstr+='\n\t\t\t\t\t\t\t\t<li class="active"><label class="tree-toggler"><a href="#">SSD Lifeleft Analysis</a></label>'
        datstr+='\n\t\t\t\t\t\t\t\t<ul class="nav nav-list tree">'
        datstr+='\n\t\t\t\t\t\t\t\t\t<li><a href="7000.html">7000 System</a></li>'
        datstr+='\n\t\t\t\t\t\t\t\t\t<li><a href="vclass.html">V Class </a></li>'
        datstr+='\n\t\t\t\t\t\t\t\t\t<li><a href="tclass.html">T Class</a></li>'
        datstr+='\n\t\t\t\t\t\t\t\t\t<li><a href="fclass.html">F Class</a></li>'
...
def get_data():
        try:
            ...
            sqlstmt="SELECT OUTPUT_FILE_NAME,FILE_LOCATION,HTML_TEMPLATE,HTML_FILE_NAME,JSON_URL_HTML,REPORT_TITLE FROM GRAPH_REPORT_DATA where HTML_TEMPLATE='lifelefthtml.py'";
