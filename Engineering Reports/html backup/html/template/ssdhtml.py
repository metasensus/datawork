...
def read_data(json_file,json_location,html_template,html_name,json_url):
    try:
 
        #resultset=setconnection(hostname,dbtype,sourcedb,dbuser,query_string);
        fl=open(html_name,'w');
        optimuslogger=open('log/ssdhtml.log','a');
        datarray=[];
        datstr='\n<html>';
        datstr+='\n<head>';
	...
	datstr+='\n\t\t\t\t\t</div>'
        ...
        errlog=open('log/htmlreport_error.log','a');
        function='read data';
        #optimuslogger.write('---------------------------------------------------------------------------------------------------------------------------------------------\n');
...
def get_data():
        try:
            ...
            for rec in htmlResultset:
                ...
                read_data(json_file,json_location,html_template,html_name,json_url);
        except:
